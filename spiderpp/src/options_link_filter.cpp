...
bool OptionsLinkFilter::checkRestriction(Restriction restriction, const LinkInfo& linkInfo) const
{
...
bool OptionsLinkFilter::isUrlAllowedToCrawl(const Url& url, LinkParameter linkParameter) const
{
	...
	const bool isNofollowLink = linkParameter == LinkParameter::NofollowParameter;
