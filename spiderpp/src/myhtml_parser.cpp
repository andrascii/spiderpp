...
{
	return getLinkRelUrl("alternate", "hreflang", false);
}
...
std::vector<Url> MyHtmlParser::getLinkRelUrl(const char* relValue, const char* requiredAttribute, bool getFirstValueOnly) const
{
